...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl text-green-600 font-medium'>Find by Speciality</h1>
            <p className='sm:w-1/3 text-center text-green-600 text-sm'>Simply browse through our extensive list of trusted doctors, schedule your appointment hassle-free.</p>
